...
public class MisProgramadosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mis_programados);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(MisProgramadosActivity.this, MisProgramadosDetalleActivity.class);
        ...
        myRef.child("programados/"+user.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.hasChildren()) {
                    Toast.makeText(MisProgramadosActivity.this, "No tiene viajes programados", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(MisProgramadosActivity.this, "ERROR descargando de la base de datos" + databaseError
