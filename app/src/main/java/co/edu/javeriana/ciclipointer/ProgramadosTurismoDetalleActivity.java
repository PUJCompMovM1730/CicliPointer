...
public class ProgramadosTurismoDetalleActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_programados_turismo_detalle);
    ...
    private void enMovimiento(){
        ...
        if(complete) {
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(ProgramadosTurismoDetalleActivity.this, "Error con el servidor", Toast.LENGTH_SHORT).show();
            } catch (InterruptedException e) {
                tiempo.setText("");
                distanci.setText("Vuelva a iniciar recorrido");
                e.printStackTrace();
                Toast.makeText(ProgramadosTurismoDetalleActivity.this, "Se perdió conexión", Toast.LENGTH_SHORT).show();
            } catch (IOException e) {
                tiempo.setText("");
                distanci.setText("Vuelva a iniciar recorrido");
                e.printStackTrace();
                Toast.makeText(ProgramadosTurismoDetalleActivity.this, "Error en la ruta", Toast.LENGTH_SHORT).show();
            }
    ...
    private void guardarProgramado() {
        ...
        myRef.child("programados/"+user.getUid()+"/"+key)
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(ProgramadosTurismoDetalleActivity.this, "Guardando futuro recorrido", Toast.LENGTH_LONG).show();
