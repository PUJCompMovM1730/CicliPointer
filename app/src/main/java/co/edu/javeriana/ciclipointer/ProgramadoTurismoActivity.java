...
public class ProgramadoTurismoActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_programado_turismo);
        ...
        rutas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (origen == null) {
                    Toast.makeText(ProgramadoTurismoActivity.this, "Especifique un origen", Toast.LENGTH_SHORT).show();
                    complete = false;
                }
                if (desti == null) {
                    Toast.makeText(ProgramadoTurismoActivity.this, "Especifique un destino", Toast.LENGTH_SHORT).show();
                    complete = false;
                }
                if (complete) {
                    ...
                    try {
                        ...
                        if (results.routes.length > 0) {
                            ...
                            Toast.makeText(ProgramadoTurismoActivity.this, "No se encuentran rutas", Toast.LENGTH_SHORT).show();
                    } catch (com.google.maps.errors.ApiException e) {
                        e.printStackTrace();
                        Toast.makeText(ProgramadoTurismoActivity.this, "Error con el servidor", Toast.LENGTH_SHORT).show();
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                        Toast.makeText(ProgramadoTurismoActivity.this, "Se perdió conexión", Toast.LENGTH_SHORT).show();
                    } catch (IOException e) {
                        e.printStackTrace();
                        Toast.makeText(ProgramadoTurismoActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        if (!addressString.isEmpty()) {
            try {
                ...
                if (addresses != null && !addresses.isEmpty()) {
                    ...
                    Toast.makeText(ProgramadoTurismoActivity.this, "Dirección no encontrada", Toast.LENGTH_SHORT).show();
                    destinoAzul.setVisible(false);
                }
            } catch (IOException e) {
                e.printStackTrace();
            ...
            Toast.makeText(ProgramadoTurismoActivity.this, "La dirección esta vacía", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void busquedaAvanzada(){
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onError(Status status) {
                Toast.makeText(ProgramadoTurismoActivity.this, "Error cargando destino", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void crearRutaProgramada(RutaProgramada ru){
        String key = myRef.child("turismo programadas").push().getKey();
        myRef.child("turismo programadas/"+key)
                .setValue(ru).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Toast.makeText(ProgramadoTurismoActivity.this, "Guardando futuro recorrido", Toast.LENGTH_LONG).show();
