    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tFecha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog dialos = new DatePickerDialog(ProgramarViajeActivity.this,
        ...
        mDateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                ...
                if(fecha.equals("")) {
                    Toast.makeText(ProgramarViajeActivity.this, "Fecha invalida", Toast.LENGTH_SHORT).show();
        ...
        tHora.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TimePickerDialog dialog = new TimePickerDialog(ProgramarViajeActivity.this,mTimeSetLister,hora,minutos,false);
                dialog.show();
            }
        });
        ...
        continuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!fecha.equals("")&&!time.equals("")){
                    Intent intent = new Intent(getApplicationContext(),ProgramadoActivity.class);
                    intent.putExtra("fecha",fecha);
                    intent.putExtra("hora",time);
                    intent.putExtra("tipo","Programado-Personal");
                    startActivity(intent);
                }else{
                    Toast.makeText(ProgramarViajeActivity.this, "Primero seleccione fecha y hora", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
